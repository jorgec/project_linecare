...
from doctor_profiles.modules.response_templates.doctor_profile import (
    public_doctor_profile_template,
)
from doctor_profiles.serializers import MedicalInstitutionSerializer
from doctor_profiles.serializers.doctor_profile_serializers import (
    DoctorProfilePrivateSerializer,
...
class ApiPublicDoctorProfileMedicalInstitutions(APIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        serializer = MedicalInstitutionSerializer(
            doctor.get_medical_institutions(), many=True
        )
