...
from doctor_profiles.serializers.diagnosis_serializers import Diagnoseserializer, DiagnosisCreateSerializer, \
    PatientDiagnosisCreateSerializer, PatientDiagnoseserializer
    ...
    def post(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            try:
                ...
                return Response("That diagnosis has already been added! If you don't see it, check the dismissed list.",
