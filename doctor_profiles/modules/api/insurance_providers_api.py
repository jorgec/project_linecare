...
from doctor_profiles.serializers import (
    ...
    InsuranceProviderPublicSerializer,
    DoctorInsuranceSerializer,
    DoctorInsuranceCreateSerializer,
    DoctorInsuranceUpdateSerializer,
...
class ApiPrivateDoctorInsuranceUpdate(APIView):
    ...
    def post(self, request, *args, **kwargs):
        doctor_insurance = get_object_or_404(
            DoctorInsurance,
            id=request.GET.get("insurance", None),
...
class ApiPublicDoctorInsuranceDetail(APIView):
    ...
    def get(self, request, *args, **kwargs):
        doctor_insurance = get_object_or_404(
            DoctorInsurance, id=request.GET.get("insurance", None)
        )
