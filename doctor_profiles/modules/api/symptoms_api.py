...
from doctor_profiles.serializers.symptom_serializers import (
    SymptomSerializer,
    SymptomCreateSerializer,
    PatientSymptomCreateSerializer,
...
class ApiPrivatePatientDismissedSymptomList(APIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        serializer = PatientSymptomSerializer(
            checkup.get_dismissed_symptoms(), many=True
        )
    ...
    def post(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            try:
                ...
                return Response(
                    "That symptom has already been added! If you don't see it, check the dismissed list.",
...
class ApiPrivatePatientSymptomRemove(APIView):
    ...
    def post(self, request, *args, **kwargs):
        patient_symptom = get_object_or_404(
            PatientSymptom,
            symptom_id=request.GET.get("id", None),
...
class ApiPrivatePatientSymptomUndismiss(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if patient_symptom.removed_by == doctor:
            ...
            return Response(
                f"Only {patient_symptom.removed_by} can undismiss this entry",
                status=status.HTTP_403_FORBIDDEN,
            )
